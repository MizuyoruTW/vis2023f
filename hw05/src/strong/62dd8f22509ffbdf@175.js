function _1(md) {
  return (
    md`# HW5 Strong baseline (加入蘋果成積 2pt)`
  )
}

function _simple1(d3, data, drag, url_list, invalidation) {
  // 指定圖表的尺寸。
  const width = 500
    ;
  const height = 400;
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("simple1")).define("simple1", ["d3", "data", "drag", "url_list", "invalidation"], _simple1);
